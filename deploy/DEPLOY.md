...
- [ ] В «Настройки сайта» загрузить `content/site/logo.jpg` (логотип) и `content/site/pricelist.xlsx` (прайс-лист) — логотип появится в шапке сайта, прайс-лист — кнопкой скачивания в правой панели.
